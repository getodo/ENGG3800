...
/**
  * @brief  Initialise HTS221 Sensor
  * @param  none
  * @retval none
  */
void hts221_init() {
...
/**
  * @brief  Read temperature data from Sensor with I2C
  * @param  none
  * @retval The temperature value
  */
float hts221_read_temp() {

	/*variables for temp. raw data*/
...
/**
  * @brief  Read humidity from Sensor with I2C
  * @param  none
  * @retval The humidity value
  */
float hts221_read_humid() {

	/*variables for humidity raw data*/
    ...
    tmp_f = (float)(H_T_out - H0_T0_out) * (float)(H1_rh - H0_rh) / (float)(H1_T0_out - H0_T0_out);
