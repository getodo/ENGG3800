...
/* Variables for registers addresses for EEPROM*/
...
/**
  * @brief  Initialise M95M02 EEPROM
  * @param  None
  * @retval None
  */
void m95m02_init()
...
/**
  * @brief  Check if status register is busy
  * @param  None
  * @retval None
  */
void m95m02_wip()
...
/**
  ...
  * @param  uint32_t addr, uint8_t data
  * @retval None
  */
...
/**
  ...
  * @param  uint32_t addr
  * @retval uint8_t data - data read from the eeprom
  */
...
/**
  ...
  * @param  int page
  * @retval static uint8_t data[256] - pointer to data read from eeprom
  */
...
/**
  ...
  * @param  uint8_t *dataArray, uint32_t bytes, uint16_t page
  * @retval none
  */
